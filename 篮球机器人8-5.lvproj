...
<Project Type="Project" LVVersion="16008000">
	...
	<Property Name="varPersistentID:{38C1FF6A-B189-4160-85C3-F8397B20FC80}" Type="Ref">/myRIO-1900/jgld.lvlib/拟合结果</Property>
	<Property Name="varPersistentID:{E62E0059-AA0B-4366-9369-244A631BEF3D}" Type="Ref">/myRIO-1900/position.lvlib/目前位置</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="第一回合上位机.vi" Type="VI" URL="../第一回合上位机.vi"/>
		<Item Name="第一回合状态.ctl" Type="VI" URL="../第一回合状态.ctl"/>
		<Item Name="数字转字符串.vi" Type="VI" URL="../数字转字符串.vi"/>
		<Item Name="左右转.vi" Type="VI" URL="../左右转.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="circle fit data.vi" Type="VI" URL="../circle fit data.vi"/>
			<Item Name="Hokuyo URG Series.lvlib" Type="Library" URL="../Hokuyo URG Series/Hokuyo URG Series.lvlib"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="激光雷达子VI.vi" Type="VI" URL="../激光雷达子VI.vi"/>
			<Item Name="求弧对应的角度.vi" Type="VI" URL="../求弧对应的角度.vi"/>
			<Item Name="取最小值.vi" Type="VI" URL="../取最小值.vi"/>
			<Item Name="最小二乘法拟合圆 3.vi" Type="VI" URL="../最小二乘法拟合圆 3.vi"/>
			<Item Name="最小二乘法拟合圆.vi" Type="VI" URL="../最小二乘法拟合圆.vi"/>
		</Item>
...
AddOutputFilter chunkFilter
		...
		<Item Name="jgld.lvlib" Type="Library" URL="../jgld.lvlib"/>
		<Item Name="main.vi" Type="VI" URL="../main.vi"/>
		<Item Name="position.lvlib" Type="Library" URL="../position.lvlib"/>
		<Item Name="点对点.vi" Type="VI" URL="../点对点.vi"/>
		<Item Name="调整角度.vi" Type="VI" URL="../调整角度.vi"/>
		<Item Name="击球.vi" Type="VI" URL="../击球.vi"/>
		<Item Name="接收消息解析.vi" Type="VI" URL="../接收消息解析.vi"/>
		<Item Name="距离.vi" Type="VI" URL="../距离.vi"/>
		<Item Name="控速.vi" Type="VI" URL="../控速.vi"/>
		<Item Name="轮速控制（新）.vi" Type="VI" URL="../轮速控制（新）.vi"/>
		<Item Name="应到角度.vi" Type="VI" URL="../应到角度.vi"/>
		<Item Name="找球.vi" Type="VI" URL="../找球.vi"/>
		<Item Name="正反控制.vi" Type="VI" URL="../正反控制.vi"/>
		<Item Name="转字符串.vi" Type="VI" URL="../转字符串.vi"/>
		<Item Name="左转0.85？.vi" Type="VI" URL="../左转0.85？.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
			...
			<Item Name="control1.ctl" Type="VI" URL="../../2017-7-21/control1.ctl"/>
			...
			<Item Name="发送标志位.vi" Type="VI" URL="../../2017-7-21/发送标志位.vi"/>
			<Item Name="左右转.vi" Type="VI" URL="../左右转.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
